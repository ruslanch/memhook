  ...
  typedef boost::multi_index_container<
    ...
    boost::multi_index::indexed_by<
      boost::multi_index::hashed_unique<
        boost::multi_index::member<AggregatedTraceInfo, AggregatedCallstack,
            &AggregatedTraceInfo::callstack>,
        CallstackContainerHashByIpAndSp, CallstackContainerEqualByIpAndSp
      >,
      boost::multi_index::ordered_non_unique<
        boost::multi_index::member<AggregatedTraceInfo, std::size_t,
            &AggregatedTraceInfo::memsize>
      >,
      boost::multi_index::ordered_non_unique<
        boost::multi_index::member<AggregatedTraceInfo, std::size_t,
            &AggregatedTraceInfo::times>
      >
    >
