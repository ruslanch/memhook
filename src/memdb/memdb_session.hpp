...
class memdb_session
    : public boost::enable_shared_from_this<memdb_session>
    , private boost::noncopyable {
public:
    explicit memdb_session(const boost::shared_ptr<mapped_storage> &storage,
...
private:
    ...
    typedef boost::function<parsing_info ()> parsing_callback;

    parsing_info parse_outbound();
    parsing_info parse_inbound();

    void on_read_complete(const parsing_callback &callback, const boost::system::error_code& e);
