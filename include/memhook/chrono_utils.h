...
void ChronoTimePointFromString(const std::string &string, boost::chrono::time_point<Clock, Duration> &time_point)
{
...
void ChronoDurationFromString(const std::string &string, boost::chrono::duration<Rep, Period> &duration)
{
    std::istringstream sstream(string);
    sstream >> duration;
}
